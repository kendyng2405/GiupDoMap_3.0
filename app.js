...
import { router }               from "./controllers/Router.js?v=4";
import { AuthController }       from "./controllers/AuthController.js?v=4";
import { HomeController }       from "./controllers/HomeController.js?v=4";
import { ProfileController }    from "./controllers/ProfileController.js?v=4";
import { AdminController }      from "./controllers/AdminController.js?v=4";
import { SuggestionController } from "./controllers/SuggestionController.js?v=4";
...
router
  ...
  .register("/privacy-policy",           () => { import("./views/ViewEngine.js?v=4").then(m => m.renderView("privacy-policy")); document.body.scrollTop = 0; })
